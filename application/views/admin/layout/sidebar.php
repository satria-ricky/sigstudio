    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SIG MUSIK <sup>Admin</sup></div>
            </a>
            ...
            <li class="nav-item <?= ($menu == 1) ? 'active' : ''; ?>">
                <a class="nav-link " href="<?php echo base_url('admin/C_data_studio') ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Data Studio Musik</span></a>
            </li>
            ...
            <li class="nav-item <?= ($menu == 3) ? 'active' : ''; ?>">
                <a class="nav-link " href="<?php echo base_url('admin/C_data_user') ?>">
